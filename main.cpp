...
#define test 1
    ...
    Camera cam = Camera(vec3(700,700,300), vec3(800,800,250), 600,1280,720);
    ...
    Ciel* ciel = new CielSoleil(SourceLumiere(vec3(0.8,0.8,1.0)), Soleil(SourceLumiere(vec3(1,1,0.1),0.2,0.8,0.9,20),glm::normalize(vec3(1,-1,1))),500);
